  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, rgba(179,136,255,0.2), rgba(255,94,168,0.2))", filter: "blur(8px)" }}
      />

      <div
        className="relative rounded-2xl overflow-hidden"
        style={{ border: "1px solid rgba(179,136,255,0.15)", aspectRatio: "9/16", maxHeight: "520px" }}
      >
        <iframe
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        >
          <a
            ...
            className="group relative inline-flex items-center gap-3 px-10 py-5 rounded-full font-poppins font-medium tracking-wider text-white transition-all duration-300 hover:scale-105"
            style={{
